...
modA %>%
  ev(amt=4*73,cmt="VEN",rate=4*73,ii=12,addl=13)%>%
  mrgsim(end=24*7,delta=0.1) %>% plot()
...
modP %>%
  ev(amt=4*19,cmt="VEN",rate=3*19,ii=12,addl=13)%>%
  mrgsim(end=24*7,delta=0.1) %>% plot(Cvenous~time)
